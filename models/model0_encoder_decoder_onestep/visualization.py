...
def save_animation(in_sequence, out_sequence):
    num = 0 #total no of images in input and output
    fig, ax = plt.subplots(1, 1)
    images = []
    ...
    #fp_in = "/home/ubuntu/convLSTM_movingMNIST/images/frame*.png"
    #fp_out = "/home/ubuntu/convLSTM_movingMNIST/images/frames.gif"
